---
name: postmortem
description: 프로젝트 중 발생한 실패를 원인·재발방지와 함께 원장에 기록한다. 사람이 AI를 교정했을 때, 테스트가 실패하거나 버그를 발견했을 때, 또는 "이건 기록해두자", "/postmortem", "$postmortem" 이라고 할 때 사용. 같은 실수를 반복하지 않게 하는 작업이면 적극 트리거.
---
