---
name: wiki
description: 프로젝트 지식(도메인 사실·결정·spec·학습·재발방지)을 LLM Wiki에 축적·정리하고 질의한다. 새로 알게 된 사실이 생기거나, 세션 지식을 정리하거나, "위키 정리/기록", "/wiki", 압축이 임박했을 때 사용. 지식이 휘발되지 않게 하는 작업이면 적극 트리거.
---
